> 贡献指南正在维护中，其中可能包括部分已经过时的信息，维护者正在计划重构此文档。
...
这里首先给出 `Adastra` 游戏的一个样板描述文件。看到这个模板（[效果演示](https://furrygames.top/zh-cn/games/Adastra.html)），你可能已经对游戏描述文件有一个基本了解了，即使你仍然不明白，也没有关系，因为接下来，我会给你介绍每一部分的含义和写法。
